...
class MultiModalNetwork:
    ...
    @classmethod
    def from_polygon(cls, polygon, layers=['walk', 'bike'], save=True, speeds={'walk': 1., 'bike': 1.}):
        layers_graph = {}
        for layer in layers:
        ...
        return cls(layers_graph, speeds=speeds)
...
if __name__ == '__main__':
    ...
    network = MultiModalNetwork.from_polygon(study_area_polygon, speeds={'walk': 1.5, 'bike':3.})
